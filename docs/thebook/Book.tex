...
\include{prooftech/proof1}
\include{prooftech/predicate}
\include{SetTheory/settheory}
\include{Numbers/numbers}
\include{Relations/relations}
\include{SetTheory/finsets}

\include{Algebraic/algstr}
\appendix
%\appendixpage
...
\include{Installation/menus}
\include{Tactics/language}
\include{Tactics/tactics}
\include{Installation/examples}
\include{Tactics/types}
